...
import useFeatureClothes from "../Hooks/useFeatureClothes"


function FeatureClothes() {
    const { featureClothes, isLoading } = useFeatureClothes()
    return (
        <div>
            <div className="divider text-3xl font-semibold text-purple-800 py-10">Feature Clothes</div>
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-6">
                {
                    isLoading ? <div className="flex justify-center my-8 col-span-3">
                        <span className="loading loading-spinner text-secondary "></span>
                    </div> :
                        featureClothes.map(food => <>
