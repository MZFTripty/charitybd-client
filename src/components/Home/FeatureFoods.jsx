...
import useFeatureFoods from "../Hooks/useFeatureFoods"


function FeatureFoods() {
  const { featureFoods, isLoading } = useFeatureFoods()
  return (
    <div>
      <div className="divider text-3xl font-semibold text-purple-800 py-10">Feature Foods</div>
